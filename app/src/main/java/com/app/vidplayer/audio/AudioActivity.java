...
import com.app.vidplayer.activity.InfoActivity;
...
public class AudioActivity extends AppCompatActivity {
    ...
    public static final String Broadcast_PLAY_NEW_AUDIO = "com.app.vidplayer.audio.PlayNewAudio";

    private MediaPlayerService player;
    boolean serviceBound = false;
    ArrayList<Audio> audioList;
    AppCompatImageView collapsingImageView;
    RecyclerView_Adapter  re_adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_audio);
         collapsingImageView = (AppCompatImageView) findViewById(R.id.collapsingImageView);
    ...
    private void initRecyclerView() {
        if (audioList != null) {
            final RecyclerView recyclerview = (RecyclerView) findViewById(R.id.recyclerview);
             re_adapter = new RecyclerView_Adapter(audioList, getApplication());
